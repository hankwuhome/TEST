...
import { SearchInfoInitViewModel, SearchInfoViewModel, SearchListViewModel, SearchItemViewModel, EnumSort  } from '../../ViewModels/HandsetSellPriceHistory/SearchListViewModel';									  
import { HandsetSellPriceHistoryService } from '../../Services/HandsetSellPriceHistory/HandsetSellPriceHistoryService';						  
//#endregin																														  
																																  
//#region Definition																											  
@Component({																													  
    selector: 'HandsetSellPriceHistory-SearchList',																					  
    templateUrl: '../../Views/HandsetSellPriceHistory/SearchList.html',																  
...
export class SearchListController {																								  
    ...
    constructor(private router: Router,                                                               
        private service: HandsetSellPriceHistoryService,                                               
    ...
    private EditDetail(model: SearchItemViewModel) {																					  
        var path = 'handsetsellpricehistory/editdetail';																				  
		//帶入轉址參數																														  
    ...
    private ViewDetail(model: SearchItemViewModel) {																					  
        var path = 'handsetsellpricehistory/viewdetail';																				  
		//帶入轉址參數																														  
        var query_model:QueryStringViewModel[] = [];																			  
        //query_model.push(new QueryStringViewModel('Id', id));																	  
