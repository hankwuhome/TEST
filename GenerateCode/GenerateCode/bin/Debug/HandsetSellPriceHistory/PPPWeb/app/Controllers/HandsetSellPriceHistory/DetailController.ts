...
import { DetailRequesViewModel, ViewDetailViewModel, DetailViewModel } from '../../ViewModels/HandsetSellPriceHistory/DetailViewModel';							   
//#endregion																																   
																																			   
//#region Definition																														   
@Component({																																   
    selector: 'HandsetSellPriceHistory-Detail',																													   
    templateUrl: '../../Views/HandsetSellPriceHistory/Detail.html'																								   
})																																			   
//#endregin																																	   
...
export class DetailController {																												   
    ...
    private BackToSearchList() {																					  
        var path = 'handsetsellpricehistory/searchlist';																				  
		//帶入轉址參數																														  
