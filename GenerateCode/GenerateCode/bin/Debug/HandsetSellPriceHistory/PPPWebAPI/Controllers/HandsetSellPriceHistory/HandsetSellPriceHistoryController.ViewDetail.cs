...
{																																									 
    ...
    {																																								 
        ...
        [System.Web.Http.Route("Api/HandsetSellPriceHistory/ViewDetail")]													  
        ...
        {																																							 
            ...
            {																																						 
                ...
                {																																					 
                    //取得明細資料																																   
                    viewDetail.Detail = handsetSellPriceHistoryService.QueryDetail(detailRequest);																		 
                ...
                //取得明細下拉選單項目																															   
                viewDetail.DetailOption = handsetSellPriceHistoryService.QueryDetailOption();																 
            }																																						 
            catch (Exception ex)																																	 
            {																																						 
                throw ex;																																			 
