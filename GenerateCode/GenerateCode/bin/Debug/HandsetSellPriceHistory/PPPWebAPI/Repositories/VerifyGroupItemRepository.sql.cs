...
{																										  
    ...
    {																									  
        ...
        private bool AddVerifyGroupItemSql(VerifyGroupItemModel model)															  
        {																								  
        ...
        private bool UpdateVerifyGroupItemSql(VerifyGroupItemModel model)														  
        {																								  
            // 設定主SQL												 
            _sqlStr = new StringBuilder();																  
            //_sqlStr.Append("主要SQL語法 ");															  
        ...
        private bool DeleteVerifyGroupItemSql(VerifyGroupItemModel model)														  
        {																								  
            // 設定主SQL												 
            _sqlStr = new StringBuilder();																  
            //_sqlStr.Append("主要SQL語法 ");															  
