...
{																														   
    ...
    {																													   
        ...
        public bool AddVerifyFlowSetting(VerifyFlowSettingModel model)																				   
        {																												   
            #region 參數宣告																							   
            var result = false;																							   
            #endregion																									   
        ...
        public bool UpdateVerifyFlowSetting(VerifyFlowSettingModel model)																			   
        {																												   
            #region 參數宣告																							   
            var result = false;																							   
            #endregion																									   
            ...
            #region 流程																									 
            UpdateVerifyFlowSettingSql(model);																						   
            try																											   
            {																											   
                using (var cn = new SqlConnection(_dbConnPPP))															   
                {																										   
        ...
        public bool DeleteVerifyFlowSetting(VerifyFlowSettingModel model)																			   
        {																												   
            #region 參數宣告																							   
            var result = false;																							   
            #endregion																									   
            ...
            #region 流程																									 
            DeleteVerifyFlowSettingSql(model);																						   
            try																											   
            {																											   
                using (var cn = new SqlConnection(_dbConnPPP))															   
                {																										   
