...
{																										  
    public partial class ActorRepository : _BaseRepository<ActorModel>, IActorRepository						  
    {																									  
        ...
        private bool AddActorSql(ActorModel model)															  
        {																								  
            // 設定主SQL, _sqlStr 中不可以包含 ORDER BY													 
            _sqlStr = new StringBuilder();																  
            //_sqlStr.Append("主要SQL語法 ");															  
        ...
        private bool UpdateActorSql(ActorModel model)														  
        {																								  
            // 設定主SQL												 
            _sqlStr = new StringBuilder();																  
            //_sqlStr.Append("主要SQL語法 ");															  
        ...
        private bool DeleteActorSql(ActorModel model)														  
        {																								  
            // 設定主SQL												 
            _sqlStr = new StringBuilder();																  
            //_sqlStr.Append("主要SQL語法 ");															  
