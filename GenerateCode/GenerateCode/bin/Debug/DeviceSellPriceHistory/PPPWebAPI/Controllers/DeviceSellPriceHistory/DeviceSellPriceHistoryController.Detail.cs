...
{																																									 
    ...
    {																																								 
        ...
        [System.Web.Http.Route("Api/DeviceSellPriceHistory/Detail")]													  
            ...
            {																																						 
                ...
                {															
                    case _BaseDetailRequestViewModel.EnumActiveType.ADD:	
                        deviceSellPriceHistoryService.AddDetail(detail);		
                        result = true;												
                        break;												
                    case _BaseDetailRequestViewModel.EnumActiveType.EDIT:	
                        deviceSellPriceHistoryService.EditDetail(detail);		
                        result = true;												
                        break;												
                    case _BaseDetailRequestViewModel.EnumActiveType.DELETE:	
                        deviceSellPriceHistoryService.DeleteDetail(detail);		
                        result = true;												
                        break;												
                }															
            }																																						 
