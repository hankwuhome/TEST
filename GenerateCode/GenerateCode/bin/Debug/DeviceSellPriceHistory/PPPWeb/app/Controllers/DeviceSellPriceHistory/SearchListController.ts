...
import { SearchInfoInitViewModel, SearchInfoViewModel, SearchListViewModel, SearchItemViewModel, EnumSort  } from '../../ViewModels/DeviceSellPriceHistory/SearchListViewModel';									  
import { DeviceSellPriceHistoryService } from '../../Services/DeviceSellPriceHistory/DeviceSellPriceHistoryService';						  
//#endregin																														  
																																  
//#region Definition																											  
@Component({																													  
    selector: 'DeviceSellPriceHistory-SearchList',																					  
    templateUrl: '../../Views/DeviceSellPriceHistory/SearchList.html',																  
...
export class SearchListController {																								  
    ...
    private EditDetail(model: SearchItemViewModel) {																					  
        var path = 'devicesellpricehistory/editdetail';																				  
		//帶入轉址參數																														  
    ...
    private ViewDetail(model: SearchItemViewModel) {																					  
        var path = 'devicesellpricehistory/viewdetail';																				  
		//帶入轉址參數																														  
        var query_model:QueryStringViewModel[] = [];																			  
        //query_model.push(new QueryStringViewModel('Id', id));																	  
