...
import { DetailRequesViewModel, ViewDetailViewModel, DetailViewModel } from '../../ViewModels/AccessorySellPriceImport/DetailViewModel';							   
//#endregion																																   
																																			   
//#region Definition																														   
@Component({																																   
    selector: 'AccessorySellPriceImport-Detail',																													   
    templateUrl: '../../Views/AccessorySellPriceImport/Detail.html'																								   
})																																			   
//#endregin																																	   
...
export class DetailController {																												   
    ...
    private BackToSearchList() {																					  
        var path = 'accessorysellpriceimport/searchlist';																				  
		//帶入轉址參數																														  
