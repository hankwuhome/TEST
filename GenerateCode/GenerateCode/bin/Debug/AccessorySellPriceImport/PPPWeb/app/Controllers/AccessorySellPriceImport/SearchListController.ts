...
import { SearchInfoInitViewModel, SearchInfoViewModel, SearchListViewModel, SearchItemViewModel, EnumSort  } from '../../ViewModels/AccessorySellPriceImport/SearchListViewModel';									  
import { AccessorySellPriceImportService } from '../../Services/AccessorySellPriceImport/AccessorySellPriceImportService';						  
//#endregin																														  
																																  
//#region Definition																											  
@Component({																													  
    selector: 'AccessorySellPriceImport-SearchList',																					  
    templateUrl: '../../Views/AccessorySellPriceImport/SearchList.html',																  
...
export class SearchListController {																								  
    ...
    constructor(private router: Router,                                                               
        private service: AccessorySellPriceImportService,                                               
    ...
    private ViewDetail(model: SearchItemViewModel) {																					  
        var path = 'accessorysellpriceimport/viewdetail';																				  
		//帶入轉址參數																														  
