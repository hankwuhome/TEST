...
{																					  
    public class AccessorySellPriceImportService : IAccessorySellPriceImportService											  
    {																				  
        /// <summary>																  
        /// 初始化搜尋列表(下拉選單)												   
        /// </summary>																  
        ...
        {																			  
            #region 參數宣告														  
            bool result = false;													  
			BatchImportMaterialModel batchImportMaterial = new BatchImportMaterialModel(); 											  
            IBatchImportMaterialRepository batchImportMaterialRp = new BatchImportMaterialRepository();								  
            #endregion																  
																					  
            #region 流程																
			batchImportMaterial =  PropertyCopy.Convert<DetailViewModel, BatchImportMaterialModel>(detail);  
			result = batchImportMaterialRp.AddBatchImportMaterial(batchImportMaterial);												  
        ...
        {																			  
            ...
            #region 流程																
			batchImportMaterial =  PropertyCopy.Convert<DetailViewModel, BatchImportMaterialModel>(detail);  
			result = batchImportMaterialRp.UpdateBatchImportMaterial(batchImportMaterial);											  
        ...
        {																			  
            ...
            #region 流程																
			batchImportMaterial =  PropertyCopy.Convert<DetailViewModel, BatchImportMaterialModel>(detail);  
			result = batchImportMaterialRp.DeleteBatchImportMaterial(batchImportMaterial);											  
