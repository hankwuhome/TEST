...
{																														   
    ...
    {																													   
        ...
        public bool AddBatchImportMaterial(BatchImportMaterialModel model)																				   
        {																												   
            #region 參數宣告																							   
            var result = false;																							   
            #endregion																									   
            ...
            #region 流程																									 
            AddBatchImportMaterialSql(model);																							   
            try																											   
            {																											   
                using (var cn = new SqlConnection(_dbConnPPP))															   
                {																										   
        ...
        public bool UpdateBatchImportMaterial(BatchImportMaterialModel model)																			   
        {																												   
            #region 參數宣告																							   
            var result = false;																							   
            #endregion																									   
            ...
            #region 流程																									 
            UpdateBatchImportMaterialSql(model);																						   
            try																											   
            {																											   
                using (var cn = new SqlConnection(_dbConnPPP))															   
                {																										   
        ...
        public bool DeleteBatchImportMaterial(BatchImportMaterialModel model)																			   
        {																												   
            #region 參數宣告																							   
            var result = false;																							   
            #endregion																									   
            ...
            #region 流程																									 
            DeleteBatchImportMaterialSql(model);																						   
            try																											   
            {																											   
                using (var cn = new SqlConnection(_dbConnPPP))															   
                {																										   
