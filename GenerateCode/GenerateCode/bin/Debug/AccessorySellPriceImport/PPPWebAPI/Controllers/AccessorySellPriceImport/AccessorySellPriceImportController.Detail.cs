...
{																																									 
    ...
    {																																								 
        ...
        [System.Web.Http.Route("Api/AccessorySellPriceImport/Detail")]													  
            ...
            {																																						 
                ...
                {															
                    case _BaseDetailRequestViewModel.EnumActiveType.ADD:	
                        accessorySellPriceImportService.AddDetail(detail);		
                        result = true;												
                        break;												
                    case _BaseDetailRequestViewModel.EnumActiveType.EDIT:	
                        accessorySellPriceImportService.EditDetail(detail);		
                        result = true;												
                        break;												
                    case _BaseDetailRequestViewModel.EnumActiveType.DELETE:	
                        accessorySellPriceImportService.DeleteDetail(detail);		
                        result = true;												
                        break;												
                }															
            }																																						 
