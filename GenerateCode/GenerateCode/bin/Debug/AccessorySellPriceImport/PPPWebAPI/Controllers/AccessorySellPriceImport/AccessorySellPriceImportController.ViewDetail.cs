...
{																																									 
    ...
    {																																								 
        ...
        [System.Web.Http.Route("Api/AccessorySellPriceImport/ViewDetail")]													  
        ...
        {																																							 
            ...
            {																																						 
                ...
                {																																					 
                    //取得明細資料																																   
                    viewDetail.Detail = accessorySellPriceImportService.QueryDetail(detailRequest);																		 
                ...
                //取得明細下拉選單項目																															   
                viewDetail.DetailOption = accessorySellPriceImportService.QueryDetailOption();																 
            }																																						 
            catch (Exception ex)																																	 
            {																																						 
                throw ex;																																			 
