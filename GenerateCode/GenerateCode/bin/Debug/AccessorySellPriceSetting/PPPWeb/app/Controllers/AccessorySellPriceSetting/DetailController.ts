...
import { DetailRequesViewModel, ViewDetailViewModel, DetailViewModel } from '../../ViewModels/AccessorySellPriceSetting/DetailViewModel';							   
//#endregion																																   
																																			   
//#region Definition																														   
@Component({																																   
    selector: 'AccessorySellPriceSetting-Detail',																													   
    templateUrl: '../../Views/AccessorySellPriceSetting/Detail.html'																								   
})																																			   
//#endregin																																	   
...
export class DetailController {																												   
    ...
    constructor(																															   
        ...
        private service: AccessorySellPriceSettingService,																										   
    ...
    private BackToSearchList() {																					  
        var path = 'accessorysellpricesetting/searchlist';																				  
		//帶入轉址參數																														  
