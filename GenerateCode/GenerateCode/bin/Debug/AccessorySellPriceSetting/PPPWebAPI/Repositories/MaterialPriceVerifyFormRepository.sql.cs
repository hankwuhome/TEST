...
{																										  
    ...
    {																									  
        ...
        private bool AddMaterialPriceVerifyFormSql(MaterialPriceVerifyFormModel model)															  
        {																								  
        ...
        private bool UpdateMaterialPriceVerifyFormSql(MaterialPriceVerifyFormModel model)														  
        {																								  
            // 設定主SQL												 
            _sqlStr = new StringBuilder();																  
            //_sqlStr.Append("主要SQL語法 ");															  
        ...
        private bool DeleteMaterialPriceVerifyFormSql(MaterialPriceVerifyFormModel model)														  
        {																								  
            // 設定主SQL												 
            _sqlStr = new StringBuilder();																  
            //_sqlStr.Append("主要SQL語法 ");															  
