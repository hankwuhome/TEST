...
{																										  
    ...
    {																									  
        ...
        private bool AddCategoryGrossProfitSettingSql(CategoryGrossProfitSettingModel model)															  
        {																								  
        ...
        private bool UpdateCategoryGrossProfitSettingSql(CategoryGrossProfitSettingModel model)														  
        {																								  
            // 設定主SQL												 
            _sqlStr = new StringBuilder();																  
            //_sqlStr.Append("主要SQL語法 ");															  
        ...
        private bool DeleteCategoryGrossProfitSettingSql(CategoryGrossProfitSettingModel model)														  
        {																								  
            // 設定主SQL												 
            _sqlStr = new StringBuilder();																  
            //_sqlStr.Append("主要SQL語法 ");															  
