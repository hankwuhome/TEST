...
{																														   
    ...
    {																													   
        ...
        public bool AddMaterialSetting(MaterialSettingModel model)																				   
        {																												   
            #region 參數宣告																							   
            var result = false;																							   
            #endregion																									   
        ...
        public bool UpdateMaterialSetting(MaterialSettingModel model)																			   
        {																												   
            #region 參數宣告																							   
            var result = false;																							   
            #endregion																									   
            ...
            #region 流程																									 
            UpdateMaterialSettingSql(model);																						   
            try																											   
            {																											   
                using (var cn = new SqlConnection(_dbConnPPP))															   
                {																										   
        ...
        public bool DeleteMaterialSetting(MaterialSettingModel model)																			   
        {																												   
            #region 參數宣告																							   
            var result = false;																							   
            #endregion																									   
            ...
            #region 流程																									 
            DeleteMaterialSettingSql(model);																						   
            try																											   
            {																											   
                using (var cn = new SqlConnection(_dbConnPPP))															   
                {																										   
