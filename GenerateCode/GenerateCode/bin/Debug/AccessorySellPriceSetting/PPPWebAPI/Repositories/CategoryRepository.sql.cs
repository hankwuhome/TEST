...
{																										  
    public partial class CategoryRepository : _BaseRepository<CategoryModel>, ICategoryRepository						  
    {																									  
        #region Private Methods																			  
        private bool AddCategorySql(CategoryModel model)															  
        {																								  
        ...
        private bool UpdateCategorySql(CategoryModel model)														  
        {																								  
            // 設定主SQL												 
            _sqlStr = new StringBuilder();																  
            //_sqlStr.Append("主要SQL語法 ");															  
        ...
        private bool DeleteCategorySql(CategoryModel model)														  
        {																								  
            // 設定主SQL												 
            _sqlStr = new StringBuilder();																  
            //_sqlStr.Append("主要SQL語法 ");															  
