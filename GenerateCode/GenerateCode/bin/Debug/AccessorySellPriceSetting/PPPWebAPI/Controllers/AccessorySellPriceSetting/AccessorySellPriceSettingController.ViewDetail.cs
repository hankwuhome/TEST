...
{																																									 
    ...
    {																																								 
        ...
        [System.Web.Http.Route("Api/AccessorySellPriceSetting/ViewDetail")]													  
        ...
        {																																							 
            ...
            {																																						 
                ...
                {																																					 
                    //取得明細資料																																   
                    viewDetail.Detail = accessorySellPriceSettingService.QueryDetail(detailRequest);																		 
                ...
                //取得明細下拉選單項目																															   
                viewDetail.DetailOption = accessorySellPriceSettingService.QueryDetailOption();																 
            }																																						 
            catch (Exception ex)																																	 
            {																																						 
                throw ex;																																			 
