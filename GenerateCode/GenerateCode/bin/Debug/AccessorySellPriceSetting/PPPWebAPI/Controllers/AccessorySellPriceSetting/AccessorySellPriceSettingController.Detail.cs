...
{																																									 
    ...
    {																																								 
        ...
        [System.Web.Http.Route("Api/AccessorySellPriceSetting/Detail")]													  
            ...
            {																																						 
                ...
                {															
                    case _BaseDetailRequestViewModel.EnumActiveType.ADD:	
                        accessorySellPriceSettingService.AddDetail(detail);		
                        result = true;												
                        break;												
                    case _BaseDetailRequestViewModel.EnumActiveType.EDIT:	
                        accessorySellPriceSettingService.EditDetail(detail);		
                        result = true;												
                        break;												
                    case _BaseDetailRequestViewModel.EnumActiveType.DELETE:	
                        accessorySellPriceSettingService.DeleteDetail(detail);		
                        result = true;												
                        break;												
                }															
            }																																						 
