...
import { DetailRequesViewModel, ViewDetailViewModel, DetailViewModel } from '../../ViewModels/ProjectPriceSell/DetailViewModel';							   
//#endregion																																   
																																			   
//#region Definition																														   
@Component({																																   
    selector: 'ProjectPriceSell-Detail',																													   
    templateUrl: '../../Views/ProjectPriceSell/Detail.html'																								   
})																																			   
//#endregin																																	   
...
export class DetailController {																												   
    ...
    private BackToSearchList() {																					  
        var path = 'projectpricesell/searchlist';																				  
		//帶入轉址參數																														  
