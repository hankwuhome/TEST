...
{																										  
    public partial class SellRepository : _BaseRepository<SellModel>, ISellRepository						  
    {																									  
        #region Private Methods																			  
        private bool AddSellSql(SellModel model)															  
        {																								  
        ...
        private bool UpdateSellSql(SellModel model)														  
        {																								  
            // 設定主SQL												 
            _sqlStr = new StringBuilder();																  
            //_sqlStr.Append("主要SQL語法 ");															  
        ...
        private bool DeleteSellSql(SellModel model)														  
        {																								  
            // 設定主SQL												 
            _sqlStr = new StringBuilder();																  
            //_sqlStr.Append("主要SQL語法 ");															  
