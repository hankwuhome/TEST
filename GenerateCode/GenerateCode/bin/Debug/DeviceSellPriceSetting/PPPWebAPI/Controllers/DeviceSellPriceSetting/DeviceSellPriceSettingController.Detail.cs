...
{																																									 
    ...
    {																																								 
        ...
        [System.Web.Http.Route("Api/DeviceSellPriceSetting/Detail")]													  
            ...
            {																																						 
                ...
                {															
                    case _BaseDetailRequestViewModel.EnumActiveType.ADD:	
                        deviceSellPriceSettingService.AddDetail(detail);		
                        result = true;												
                        break;												
                    case _BaseDetailRequestViewModel.EnumActiveType.EDIT:	
                        deviceSellPriceSettingService.EditDetail(detail);		
                        result = true;												
                        break;												
                    case _BaseDetailRequestViewModel.EnumActiveType.DELETE:	
                        deviceSellPriceSettingService.DeleteDetail(detail);		
                        result = true;												
                        break;												
                }															
            }																																						 
