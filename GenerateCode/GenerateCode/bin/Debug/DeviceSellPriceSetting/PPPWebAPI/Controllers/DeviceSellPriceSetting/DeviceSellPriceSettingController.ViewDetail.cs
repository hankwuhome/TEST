...
{																																									 
    ...
    {																																								 
        ...
        [System.Web.Http.Route("Api/DeviceSellPriceSetting/ViewDetail")]													  
        ...
        {																																							 
            ...
            {																																						 
                ...
                {																																					 
                    //取得明細資料																																   
                    viewDetail.Detail = deviceSellPriceSettingService.QueryDetail(detailRequest);																		 
                ...
                //取得明細下拉選單項目																															   
                viewDetail.DetailOption = deviceSellPriceSettingService.QueryDetailOption();																 
            }																																						 
            catch (Exception ex)																																	 
            {																																						 
                throw ex;																																			 
