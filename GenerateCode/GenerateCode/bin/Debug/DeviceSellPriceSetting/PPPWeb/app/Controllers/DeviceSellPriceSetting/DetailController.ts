...
import { DetailRequesViewModel, ViewDetailViewModel, DetailViewModel } from '../../ViewModels/DeviceSellPriceSetting/DetailViewModel';							   
//#endregion																																   
																																			   
//#region Definition																														   
@Component({																																   
    selector: 'DeviceSellPriceSetting-Detail',																													   
    templateUrl: '../../Views/DeviceSellPriceSetting/Detail.html'																								   
})																																			   
//#endregin																																	   
...
export class DetailController {																												   
    ...
    constructor(																															   
        ...
        private service: DeviceSellPriceSettingService,																										   
    ...
    private BackToSearchList() {																					  
        var path = 'devicesellpricesetting/searchlist';																				  
		//帶入轉址參數																														  
