...
//#region Definition																											  
@Component({																													  
    selector: 'DeviceSellPriceSetting-SearchList',																					  
    templateUrl: '../../Views/DeviceSellPriceSetting/SearchList.html',																  
...
export class SearchListController {																								  
    ...
    private EditDetail(model: SearchItemViewModel) {																					  
        var path = 'devicesellpricesetting/editdetail';																				  
		//帶入轉址參數																														  
    ...
    private ViewDetail(model: SearchItemViewModel) {																					  
        var path = 'devicesellpricesetting/viewdetail';																				  
		//帶入轉址參數																														  
        var query_model:QueryStringViewModel[] = [];																			  
        //query_model.push(new QueryStringViewModel('Id', id));																	  
