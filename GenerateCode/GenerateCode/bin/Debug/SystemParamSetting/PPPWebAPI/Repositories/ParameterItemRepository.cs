...
{																														   
    ...
    {																													   
        ...
        public bool AddParameterItem(ParameterItemModel model)																				   
        {																												   
            #region 參數宣告																							   
            var result = false;																							   
            #endregion																									   
        ...
        public bool UpdateParameterItem(ParameterItemModel model)																			   
        {																												   
            #region 參數宣告																							   
            var result = false;																							   
            #endregion																									   
        ...
        public bool DeleteParameterItem(ParameterItemModel model)																			   
        {																												   
            #region 參數宣告																							   
            var result = false;																							   
            #endregion																									   
