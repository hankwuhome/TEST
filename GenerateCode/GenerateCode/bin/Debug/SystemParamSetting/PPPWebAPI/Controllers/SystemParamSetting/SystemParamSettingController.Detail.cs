...
{																																									 
    ...
    {																																								 
        ...
        [System.Web.Http.Route("Api/SystemParamSetting/Detail")]													  
            ...
            {																																						 
                ...
                {															
                    case _BaseDetailRequestViewModel.EnumActiveType.ADD:	
                        systemParamSettingService.AddDetail(detail);		
                        result = true;												
                        break;												
                    case _BaseDetailRequestViewModel.EnumActiveType.EDIT:	
                        systemParamSettingService.EditDetail(detail);		
                        result = true;												
                        break;												
                    case _BaseDetailRequestViewModel.EnumActiveType.DELETE:	
                        systemParamSettingService.DeleteDetail(detail);		
                        result = true;												
                        break;												
                }															
            }																																						 
