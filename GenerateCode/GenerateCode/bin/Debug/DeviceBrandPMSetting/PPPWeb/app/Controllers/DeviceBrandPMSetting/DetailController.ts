...
import { DetailRequesViewModel, ViewDetailViewModel, DetailViewModel } from '../../ViewModels/DeviceBrandPMSetting/DetailViewModel';							   
//#endregion																																   
																																			   
//#region Definition																														   
@Component({																																   
    selector: 'DeviceBrandPMSetting-Detail',																													   
    templateUrl: '../../Views/DeviceBrandPMSetting/Detail.html'																								   
})																																			   
//#endregin																																	   
...
export class DetailController {																												   
    ...
    private BackToSearchList() {																					  
        var path = 'devicebrandpmsetting/searchlist';																				  
		//帶入轉址參數																														  
