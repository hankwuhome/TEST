...
{																										  
    public partial class BrandRepository : _BaseRepository<BrandModel>, IBrandRepository						  
    {																									  
        #region Private Methods																			  
        private bool AddBrandSql(BrandModel model)															  
        {																								  
        ...
        private bool UpdateBrandSql(BrandModel model)														  
        {																								  
            // 設定主SQL												 
            _sqlStr = new StringBuilder();																  
            //_sqlStr.Append("主要SQL語法 ");															  
        ...
        private bool DeleteBrandSql(BrandModel model)														  
        {																								  
            // 設定主SQL												 
            _sqlStr = new StringBuilder();																  
            //_sqlStr.Append("主要SQL語法 ");															  
